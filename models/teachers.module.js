...
module.exports = {
    ...
    getAllClasses(id_gv) {
        return db.query(`SELECT ID_LOP_HOC, TEN_LOP FROM LOP_HOC WHERE ID_GIAO_VIEN = '${id_gv}'`);
    },

    getMarkByClass(id_gv, id_lh) {
        return db.query(`SELECT HOC_SINH.ID_HOC_SINH, HOC_SINH.HO_TEN, BANG_DIEM.DIEM_GK, BANG_DIEM.DIEM_CK, BANG_DIEM.DIEM_TK 
